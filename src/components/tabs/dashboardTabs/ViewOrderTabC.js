        ...
        <div className={requestDetailsContainer}>
          ...
          <div className={secondSection}>
            ...
            <span id="request-span">
              ...
              <ul>
                <li>Request: {name}</li>
                <li><b>Number of Tourists</b> <p>2 Adults</p> <p>2 Children</p></li>
                <li><b>Interested In:</b> <p>Hotel Pickup</p> <p>Security</p></li>
